...
class SentinelUNet(pl.LightningModule):
    def __init__(self, in_channels=10, out_channels=16, learning_rate=1e-3): # Ubah out_channels sesuai kelasmu
        ...
        # Metrik untuk CSVLogger (IoU dan Accuracy)
    ...
    def _shared_step(self, batch):
        ...
        # Untuk multi-class, y harus bertipe long [Batch, H, W]
        y = y.long()
        
        # Prediksi diambil dari indeks channel tertinggi
    ...
    def training_step(self, batch, batch_idx):
        ...
        # on_epoch=True sangat penting untuk CSVLogger per epoch
